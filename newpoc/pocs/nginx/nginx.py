...
class POC(PocBase):
    ...
    def _verify(self, url):
        self.output.error(id(POC_QUEUE))
        # import time
        # time.sleep(2)
        # self.output.check("nginx_verify:{}".format(url))

    def _attack(self, url):
        self.output.check("nginx_attack:{}".format(url))
    ...
    def _shell(self, url):
        ...
        # 攻击代码 execute cmd
        self.output.check("nginx_shell:{}".format(url))
